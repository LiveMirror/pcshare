...
BEGIN_MESSAGE_MAP(CMyToServerDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	ON_WM_PAINT()
	ON_BN_CLICKED(IDC_CREATE_NETSERVER, OnCreateNetserver)
	//}}AFX_MSG_MAP
...
void CMyToServerDlg::OnConnect() 
{
	...
	WritePrivateProfileString(PS_SHEZHI, _T("中转服务器密码"), m_ServerPass, GetIniFileName());
...
void CMyToServerDlg::OnCreateNetserver() 
{
