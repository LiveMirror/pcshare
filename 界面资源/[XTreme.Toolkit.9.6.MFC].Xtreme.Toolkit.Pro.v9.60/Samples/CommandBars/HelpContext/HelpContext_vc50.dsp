...
# ADD LINK32 /nologo /subsystem:windows /machine:I386 /out:"../../../bin/vc50/HelpContext.exe" /libpath:"../../../lib/vc50"
...
# ADD LINK32 /nologo /subsystem:windows /debug /machine:I386 /out:"../../../bin/vc50/HelpContext.exe" /pdbtype:sept /libpath:"../../../lib/vc50"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 /nologo /subsystem:windows /machine:I386 /out:"../../../bin/vc50/HelpContext.exe" /libpath:"../../../lib/vc50"
# ADD LINK32 /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /machine:I386 /out:"../../../bin/vc50/HelpContext.exe" /libpath:"../../../lib/vc50"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 /nologo /subsystem:windows /debug /machine:I386 /out:"../../../bin/vc50/HelpContext.exe" /pdbtype:sept /libpath:"../../../lib/vc50"
# ADD LINK32 /nologo /entry:"wWinMainCRTStartup" /subsystem:windows /debug /machine:I386 /out:"../../../bin/vc50/HelpContext.exe" /pdbtype:sept /libpath:"../../../lib/vc50"
...
SOURCE=.\hlp\HelpContext.hpj

!IF  "$(CFG)" == "HelpContext - Win32 Release"

# PROP Ignore_Default_Tool 1
USERDEP__HELPC="hlp\AfxCore.rtf"	"hlp\AfxPrint.rtf"	"hlp\$(TargetName).hm"	
# Begin Custom Build - Making help file...
TargetName=HelpContext
InputPath=.\hlp\HelpContext.hpj
InputName=HelpContext

"../../../bin/vc50/$(InputName).hlp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	start /wait hcw /C /E /M "hlp\$(InputName).hpj" 
	if errorlevel 1 goto :Error 
	if not exist "hlp\$(InputName).hlp" goto :Error 
	copy "hlp\$(InputName).hlp" "../../../bin/vc50/$(InputName).hlp" 
	goto :done 
	:Error 
...
SOURCE=.\hlp\HelpContext.cnt

!IF  "$(CFG)" == "HelpContext - Win32 Release"

# PROP Ignore_Default_Tool 1
# Begin Custom Build - Copying contents file...
InputPath=.\hlp\HelpContext.cnt
InputName=HelpContext

"../../../bin/vc50/$(InputName).cnt" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy "hlp\$(InputName).cnt" "../../../bin/vc50/$(InputName).cnt"
