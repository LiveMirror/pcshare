...
void CControlFavorites::Serialize(CArchive& ar)
{
	...
	if(h != INVALID_HANDLE_VALUE)
	{
		...
		do
		{
			if(wfd.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY)
			{
				...
				CXTPControlPopup* pControl = (CXTPControlPopup*)m_pControls->Add(xtpControlButtonPopup, ID_FAVORITE_FOLDER, "", nStartPos + nPos, TRUE);
