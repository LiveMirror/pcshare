...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	CXTPPaintManager::SetCustomTheme(new CACDSeeTheme());
...
{
	m_wmdSpliter.CreateStatic(this, 1, 2);

	m_wmdSpliter.CreateView(0, 0, RUNTIME_CLASS(CACDSeeTabView), CSize(230, 0), pContext);
	m_wmdSpliter.CreateView(0, 1, pContext->m_pNewViewClass, CSize(0, 0), pContext);
	m_wmdSpliter.SetActivePane(0, 1);
