...
void CMyLoginDlg::PsLogin()
{
	...
	//生成url
	TCHAR m_Url[512] = {0};
	wsprintf(m_Url, _T("http://%s/pcshareext/ip/20071026PsGetFile.asp?user=%s&pass=%s&port=%s&ver=%s"),	
			m_ServerUrl, m_User, m_Pass, m_sPortMain, m_VerifyStr);
	...
	{
		TCHAR m_Url[512] = {0};
		wsprintf(m_Url, _T("http://%s/pcshareext/ip/20071026.htm"), m_ServerUrl);
		TCHAR m_IpStr[256] = {0};
