...
typedef DWORD (WINAPI* MyGetEnvironmentVariableA)( IN LPCSTR lpName,    OUT LPSTR lpBuffer,    IN DWORD nSize );
...
public:
	...
	MyGetEnvironmentVariableA		GetEnvironmentVariable;
